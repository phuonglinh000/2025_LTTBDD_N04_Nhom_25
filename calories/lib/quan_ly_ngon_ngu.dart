...
class LocaleProvider extends ChangeNotifier {
  ...
  void setLocale(Locale locale) {
    ...
    _locale = locale;
    Lang.currentLang = locale.languageCode; 
    notifyListeners(); 
  }
}
...
class Lang {
  ...
  static final Map<String, Map<String, String>> translations = {
    'vi': {
      ...
      'full_body_burn': 'Giảm cân toàn thân',
      'belly_fat_burn': 'Đốt cháy mỡ bụng',
      '14_days': '14 ngày',
      '18_days': '18 ngày',
      '28_days': '28 ngày',
      ...
      'salmon': 'Cá hồi',
      'tomato': 'Cà chua',
      'black_bean_sweet_soup': 'Chè đỗ đen',
    ...
    'en': {
      ...
      'newbie': 'Newbie',
      'full_body_burn': 'Full body burn',
      'belly_fat_burn': 'Belly fat burn',
      '14_days': '14 days',
      '18_days': '18 days',
      '28_days': '28 days',
      ...
      'salmon': 'Salmon',
      'tomato': 'Tomato',
      'black_bean_sweet_soup': 'Black Bean Sweet Soup',
      'roasted_peanut': 'Roasted Peanut',
      'guava': 'Guava',
